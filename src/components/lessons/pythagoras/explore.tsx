...
export function ExploreSection() {
  ...
  const tU = useTranslations('lesson.pythagoras.understand');
  ...
  return (
    <div>
      ...
      <div
        className="rounded-xl p-5 mb-4 border-2 border-accent/40"
        style={{
          background:
      ...
      >
        ...
        <p className="text-sm text-muted text-center">{t('hookQuestion')}</p>
      </div>

      {/* Applications */}
      <h3 className="font-semibold text-sm text-muted tracking-widest uppercase mb-3">
        {tU('applicationsTitle')}
      </h3>
